  ...
  return (
    <section id="contact" className="relative py-20 bg-background text-foreground transition-colors overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute top-20 left-12 w-32 h-32 bg-gradient-to-br from-gray-200/60 via-gray-400/40 to-gray-600/30 rounded-full blur-xl animate-pulse"></div>
        <div className="absolute top-60 right-16 w-20 h-20 bg-gradient-to-tr from-gray-300/40 via-gray-500/30 to-gray-700/20 rounded-lg rotate-45 animate-bounce"></div>
        <div className="absolute bottom-40 left-1/3 w-16 h-16 bg-gradient-to-tl from-gray-100/60 via-gray-400/30 to-gray-700/20 rounded-full animate-ping"></div>
        <div className="absolute bottom-20 right-1/4 w-24 h-24 bg-gradient-to-bl from-gray-200/40 via-gray-500/20 to-gray-800/10 rounded-lg rotate-12 float-animation"></div>
        ...
        {/* Gradient Orbs */}
        <div className="absolute top-1/4 right-1/2 translate-x-1/2 w-96 h-96 bg-gradient-to-r from-gray-200/30 via-gray-400/20 to-transparent rounded-full blur-3xl"></div>
        <div className="absolute bottom-1/4 left-1/4 w-80 h-80 bg-gradient-to-l from-gray-400/20 via-gray-600/10 to-transparent rounded-full blur-2xl"></div>
      </div>
