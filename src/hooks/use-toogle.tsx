    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          ...
          <Moon className="absolute h-[1.2rem] w-[1.2rem] scale-0 rotate-90 transition-all duration-500 dark:scale-100 dark:rotate-0 text-gray-400" />
          
          {/* Animated background */}
          <div className="absolute inset-0 bg-gradient-to-r from-amber-500/10 to-orange-500/10 dark:from-gray-500/10 dark:to-purple-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
      ...
      >
        ...
        >
          ...
          <span>Dark</span>
          {theme === 'dark' && <div className="ml-auto h-2 w-2 rounded-full bg-gray-400" />}
        </DropdownMenuItem>
        <DropdownMenuItem 
